...
(function() {
  var expect, mockPath, mockWithGlobalDep, mockWithImportPath, mockWithNpmImportPath;
  ...
  describe('commonjs-injector Module', function() {
    ...
    describe('When bypassInjection is set to true (default)', function() {
      ...
      return it('should let you use @import.global inside the injector fn to require a global', function() {
        var mathModule;
